...
const VideoContainer = () => {
  ...
  return (
    <div className="rounded-xl md:rounded-none fixed w-full h-screen overflow-hidden translate-y-[15%]  mt-[-3rem] md:mt-[-6rem]">
    <iframe
        className="md:w-screen w-[95%] mr-4  mx-auto md:scale-150  aspect-video bg-gradient-to-r from-black  "
        src={`https://www.youtube.com/embed/${trailer_key}?autoplay=1&mute=1&controls=0&showinfo=0&modestbranding=0`}
